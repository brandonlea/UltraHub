...
public class PlayerListener extends Module {
    ...
    public PlayerListener(Ultrahub plugin) {
    ...
    public void onEnable() {
        ...
        if(config.contains("join_settings.commands")) {
            commands = config.getStringList("join_settings.commands");
        }
    }
    ...
    public void onChat(AsyncPlayerChatEvent event) {
        ...
        String prefix = config.getString("Players." + player.getUniqueId() + ".chat.prefix");

        event.setFormat(TextUtil.color(prefix + " " + player.getDisplayName()));
    }
}