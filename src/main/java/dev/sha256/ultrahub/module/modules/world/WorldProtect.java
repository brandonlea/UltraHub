...
public class WorldProtect extends Module {
    ...
    public WorldProtect(Ultrahub plugin) {
    ...
    public void onEntityDamage(EntityDamageByEntityEvent event) {
        ...
        if(event.getCause() == EntityDamageEvent.DamageCause.SUFFOCATION && event.getEntity().isInsideVehicle() && event.getEntity().getVehicle().getType() == EntityType.ENDER_PEARL) {
            event.setCancelled(true);
        }
