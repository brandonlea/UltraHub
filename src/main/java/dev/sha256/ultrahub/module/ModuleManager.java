...
import dev.sha256.ultrahub.module.modules.chat.*;
import dev.sha256.ultrahub.module.modules.hotbar.HotbarManager;
import dev.sha256.ultrahub.module.modules.player.DoubleJump;
import dev.sha256.ultrahub.module.modules.player.PlayerListener;
import dev.sha256.ultrahub.module.modules.player.PlayerOffHandSwap;
...
import dev.sha256.ultrahub.module.modules.visual.tablist.TablistManager;
import dev.sha256.ultrahub.module.modules.world.AntiWorldDownloader;
import dev.sha256.ultrahub.module.modules.world.Launchpad;
import dev.sha256.ultrahub.module.modules.world.LobbySpawn;
import dev.sha256.ultrahub.module.modules.world.WorldProtect;
...
public class ModuleManager {
    ...
    public void loadModules(Ultrahub plugin) {
        this.plugin = plugin;
        ...
        for (Module module : modules.values()) {
            try {
                module.setDisableWorlds(disabledWorlds);
                module.onEnable();
            } catch (Exception e) {
                e.printStackTrace();
    ...
    public void registerModule(Module module, String isEnabledPath) {
        Ultrahub plugin = module.getPlugin();
